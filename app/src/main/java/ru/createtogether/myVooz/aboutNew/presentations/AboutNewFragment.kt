package ru.createtogether.myVooz.aboutNew.presentations
...
import ru.createtogether.myVooz.databinding.FragmentAboutNewBinding
...
class AboutNewFragment : Fragment() {
    ...
    private fun closeFragment() {
        findNavController().navigate(AboutNewFragmentDirections.actionAboutNewFragmentToSelectGroupFragment(true))
