...
interface UserRepository {
    ...
    fun setIdUniversity(id: Int)
    fun setIdGroup(id: Int)
    fun getNameGroup(): String
    fun setNameGroup(name: String)
    fun setNameUniversity(name: String)
    fun setCurrentUser(authUserModel: AuthUserModel)
    fun addChangeListener() : Any
    fun getCurrentUserMutableLD(): MutableLiveData<Any>
