...
import ru.createtogether.myVooz.home.model.LessonDbModel
...
class DbUtils @Inject constructor(
    ...
    fun getAllUserModel(): RealmResults<AuthUserModel>{
        return realm.where(AuthUserModel::class.java).findAll()
    }
