...
import ru.createtogether.myVooz.databinding.FragmentAddNoteBinding
import ru.createtogether.myVooz.helpers.filePath.VolleyMultipartRequest
import ru.createtogether.myVooz.photo.PhotoFragment
...
class AddNoteFragment: Fragment(), OnTabItemPicked, OnSearchItemPicked, OnPhotoPicked,
    ...
    private fun loadSearchFragment(typeSearch: Int, addParam: Int){
        findNavController().navigate(AddNoteFragmentDirections.actionAddNoteFragmentToSearchFragment(typeSearch, addParam))
    }
