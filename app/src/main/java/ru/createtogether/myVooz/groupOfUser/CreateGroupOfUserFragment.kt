...
import ru.createtogether.myVooz.databinding.FragmentCreateGroupOfUserBinding
import ru.createtogether.myVooz.selectGroup.presentation.SelectGroupFragmentDirections
...
class CreateGroupOfUserFragment : Fragment() {
    ...
    private fun loadSearchFragment(typeSearch: Int, addParam: Int){
        findNavController().navigate(CreateGroupOfUserFragmentDirections.actionCreateGroupOfUserFragmentToSearchFragment(typeSearch, addParam))
    }
