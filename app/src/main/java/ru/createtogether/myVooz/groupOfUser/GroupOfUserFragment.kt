...
import ru.createtogether.myVooz.user.presentation.UserFragment
import dagger.hilt.android.AndroidEntryPoint
import ru.createtogether.myVooz.MainActivity
import ru.createtogether.myVooz.R
import ru.createtogether.myVooz.databinding.FragmentGroupOfUserBinding
...
//        }
    ...
    private fun initData(){
        ...
        binding.tvUserName.text = authUserModel!!.groupOfUser!!.nameGroup
    ...
    private fun loadSearchFragment(typeSearch: Int, addParam: Int){
        findNavController().navigate(GroupOfUserFragmentDirections.actionGroupOfUserFragmentToSearchFragment(typeSearch, addParam))
    }

    private fun loadUserListFragment(){
        findNavController().navigate(R.id.action_groupOfUserFragment_to_userListGroupOfUserFragment)
    }
