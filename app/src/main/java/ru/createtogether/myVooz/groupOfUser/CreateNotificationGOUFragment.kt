...
import ru.createtogether.myVooz.databinding.FragmentGouCreateNotificationBinding

@AndroidEntryPoint
class CreateNotificationGOUFragment : Fragment(), OnUserListItemPicked {
    companion object {
        fun newInstance(): CreateNotificationGOUFragment {
            return CreateNotificationGOUFragment()
        }
    }
    ...
    private var _binding: FragmentGouCreateNotificationBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGouCreateNotificationBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initToolbar() {
        binding.toolbar.title = getString(R.string.title_create_notification)
        addBackButton()
    }
