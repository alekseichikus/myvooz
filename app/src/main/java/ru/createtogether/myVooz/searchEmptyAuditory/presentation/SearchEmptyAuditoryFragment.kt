package ru.createtogether.myVooz.searchEmptyAuditory.presentation
...
import ru.createtogether.myVooz.databinding.FragmentSearchEmptyAuditoryBinding
import java.util.*
...
class SearchEmptyAuditoryFragment : Fragment(), OnDatePicked {
    ...
    private fun openSearchFragment(typeSearch: Int, addParam: Int){
        findNavController().navigate(SearchEmptyAuditoryFragmentDirections.actionSearchEmptyAuditoryFragmentToSearchFragment(typeSearch, addParam, minLength = 1))
    }
